...
# 登录上华工研究生雨课堂（https://gsscut.yuketang.cn），
# 控制台--> Application/Cookies(不是Local Storge)-->https://gsscut.yuketang.cn，粘贴csrftoken和sessionid的value，并复制到下面两行即可
csrftoken = "8AGLZE5JeKU8mrSeL0x7KhUSAtYBYatI" #需改成自己的
sessionid = "zsrqrdcxejmhmvl6k6xp7mqxkk2bbx3e" #需改成自己的
